...
use MainBundle\Entity\Producto;
...
class ProductoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $productos = $em->getRepository('MainBundle:Producto')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('MainBundle\Form\ProductoType', $producto);
    ...
    {
        $deleteForm = $this->createDeleteForm($producto);
        $editForm = $this->createForm('MainBundle\Form\ProductoType', $producto);
